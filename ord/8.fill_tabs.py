...
def num_rl():
    ...
    try:
        ...
        t2_result.config(text="숫자를 입력하세요")
...
# t2_number=tk.Label(tab2,text="숫자를 입력하세요",font=20)
# t2_number.pack(pady=10)

# t2_txt = tk.Text(tab2, width=5, height=3)
# t2_txt.pack()

t2_ent = tk.Entry(tab2, textvariable=string, font = "Helvetica 44 bold", width=2)
t2_ent.pack()

# t2_btn = tk.Button(tab2, text="대포", command=num_rl)
# t2_btn = tk.Button(tab2, text="대포", command = lambda:[num_rl(), randomresult()])
# t2_btn.pack(pady=5)

t2_btn_result = tk.Button(tab2, text="대포", command=randomresult)
t2_btn_result.pack(pady=5)

# t2_result = Label(tab2, text='')
t2_result = Label(tab2, text='')
